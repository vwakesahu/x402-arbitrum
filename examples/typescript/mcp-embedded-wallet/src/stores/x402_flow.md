I'll search the codebase to understand the complete x402 request/response flow and types, then provide a comprehensive explanation for building an MCP interface.
Search files...
Search files...
Search files...
Read file: typescript/packages/x402/src/types/verify/x402Specs.ts

Read file: typescript/packages/x402-fetch/src/index.ts
Search files...
